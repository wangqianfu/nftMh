...
contract NftBox is ERC721, Ownable {
    ...
    function addMinter(address minter) public onlyOwner {
        require(!minters[minter],"address already is a minter");
        minters[minter] = true;
    }
    ...
    function _removeMinter(address minter) internal {
        require(minters[minter],"minters is empty,no address can be remove");
    ...
    function burn(uint tokenId) public {
        require(ownerOf(tokenId)==msg.sender,"only can burn youself token");
        // _burn(tokenId);
